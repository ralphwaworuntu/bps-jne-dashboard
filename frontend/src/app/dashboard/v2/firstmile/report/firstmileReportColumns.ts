/** Header kolom tabel detail Report Firstmile. */
export const FIRSTMILE_REPORT_DETAIL_COLUMNS = [
    "Wilayah origin",
    "Cabang Origin",
    "RING",
    "Kategori Kiriman",
...
export type FirstmileReportColumn = (typeof FIRSTMILE_REPORT_DETAIL_COLUMNS)[number];
