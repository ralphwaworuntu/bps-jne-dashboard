...
export default function OtsCabangPageV2() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/api/ots-firstmile-cabang`, {
    ...
    const handleDownload = async () => {
        ...
        try {
            const response = await fetch(`${API_URL}/export/ots-firstmile-cabang`, {
                method: 'GET',
                headers: {
        ...
        <DashboardLayout>
            <div className="max-w-7xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <Link href="/dashboard/v2/firstmile" className="inline-flex items-center text-muted-foreground hover:text-primary mb-4 transition-colors group">
                            <ArrowLeft className="w-4 h-4 mr-2 group-hover:-translate-x-1 transition-transform" />
                            Back to Firstmile Dashboard
                        </Link>
                        <h1 className="text-3xl font-bold text-foreground tracking-tight">Firstmile OTS Cabang</h1>
                    </div>
                </div>
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm">Filtered Firstmile data for Branch Operations</p>
                            </div>
                        </div>
