        ...
        <DashboardLayout>
            <div className="max-w-6xl mx-auto">
                ...
                <header className="mb-10">
                    <h1 className="text-4xl font-bold text-foreground">Outstanding</h1>
                    <p className="text-muted-foreground mt-2">Halaman data Outstanding.</p>
                </header>
                ...
                <div className="bg-white border border-border rounded-2xl p-12 flex flex-col items-center justify-center text-center min-h-[280px]">
                    ...
                    <p className="text-sm text-muted-foreground mt-2 max-w-md">
                        Unggah template Outstanding dari halaman All Shipment untuk menampilkan data
                        di sini.
                    </p>
                </div>
            </div>
